...
export default function ImagePreviewOverlay() {
  ...
  return (
    <div className="fixed inset-0 z-30 flex items-center justify-center p-8 sm:p-6" style={{ background: 'rgba(13,9,6,.85)' }} onClick={() => dispatch(toggleImagePreview())}>
      <div className="relative max-w-full max-h-full" onClick={(e) => e.stopPropagation()}>
        ...
        <button
          ...
          className="absolute -top-3 -right-3 w-9 h-9 rounded-full flex items-center justify-center text-sm font-bold shadow-lg hover:brightness-110 transition-all text-paper-900"
          style={{
